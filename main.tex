...
\begin{figure}[H]
    ...
    \caption{Zoomed-in view of the true stress-strain curve from the tensile simulation, highlighting the detailed behavior near the onset of necking and plastic deformation.}
\end{figure}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Contour plots of von Mises stress at four representative time frames from the embedded J2 simulation, showing the evolution from elastic to localized necking.}
\end{figure}
