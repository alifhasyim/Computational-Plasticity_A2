...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Q3-PlaneStrain.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Q3-ElasticStiffness.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Q3-VonMises.png}
...
\hspace{2em}Figure~\ref{fig:Q3-PlaneStrain} shows the code section of the UMAT subroutine file
...
in the equation definition of the elastic stiffness matrix in figure~\ref{fig:Q3-ElasticStiffness}, as
 well for Von Misses stress calculation in figure~\ref{fig:Q3-VonMises}. Where in both equations,
...
\begin{figure}[H]
    ...
    \caption{Comparison of tensile test for both J2-UMAt and J2-Abaqus model. 
    The plot shows the true stress-strain curves for both models.}
\end{figure}
...
whereas the upper and lower petals have the lower stress distribution from 46 to 93 MPa, and the
four diagonal petals have stress in range of 140 until 211 MPa. This
