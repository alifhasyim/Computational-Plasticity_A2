...
\end{figure}
\vspace{1em}
\hspace{2em}Figure~\ref{fig:SDV1-2} until figure~\ref{fig:SDV9} shows the contour plot of all State Dependent Variables (SDVs)
at the final simulation time from the J2-UMAT model. 
