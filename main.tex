...
of 0.1 based on Figure 7
in the appendix of the assignment 2, 
...
four diagonal petals have stress in range of 140 until 211 MPa. This elastic state 
...
\hspace{2em}For SDV2 and SDV6, it is clear that these strain state are recorded pararelly
to the loading direction. Hence, the maximum stress for both elastic and plastic state, respectivly,
showing a tensile state. Whereas, the maximum tensile stress is located at the 
left and right side edge of the hole.
